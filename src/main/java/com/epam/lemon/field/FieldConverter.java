...
/**
 * Class represents the one field conversion approach.
 * Cobol field types described in the IBM documentation.
 *
 * All you need to add a new field conversion approach is to realize this interface and add it into the
